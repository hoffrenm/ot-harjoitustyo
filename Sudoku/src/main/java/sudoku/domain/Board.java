...
/**
 * Represent board for Sudoku-game. Upholds all the cells and uses BoardHelper
...
public class Board {
    ...
    /**
     * Creates new board for game and reveals approximately amount of cells
    ...
    /**
     * Sets numeric value to cell. Method does not allow setting value that is
     * present in conflicting fields.
     *
